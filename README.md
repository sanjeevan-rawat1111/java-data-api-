...
- Node.js 16+ (for test automation)
...
The project includes a comprehensive test automation suite with Postman collections and Newman test runner:

```bash
# Run complete test suite
./run-tests.sh

# Or run tests from tests directory
cd tests
npm install
npm run test:ci
```
...
- **Health Check Tests** - Database connectivity validation
- **Data Query Tests** - MySQL and Aerospike query operations
- **Write Operations Tests** - CRUD operations for both databases
- **Error Handling Tests** - Validation and error scenarios
- **Database Integration Tests** - End-to-end data flow testing
